            ...
            <div className="download-gate-modal__body">
              {stepsLoading ? (
                ...
                <>
                  ...
                  {hasInstagramStep && (
                    <div className="download-gate-modal__instagram">
                      <h3 className="download-gate-modal__instagram-heading">
                      ...
                      {!instagramConnected ? (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="download-gate-modal__instagram-connect"
                          onClick={(e) => {
                            e.preventDefault();
                            const w = 500;
                            const h = 600;
                        ...
                        <span className="download-gate-modal__instagram-done">✓ Complete</span>
                      ) : (
                        <span className="download-gate-modal__instagram-done download-gate-modal__instagram-done--pending">
                          {instagramExecuteLoading ? 'Completing…' : 'Connected'}
                        </span>
                      )}
                      <p className="download-gate-modal__instagram-desc">
                        {instagramExecuted ? (
...
function InstagramIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden className="download-gate-modal__instagram-icon">
