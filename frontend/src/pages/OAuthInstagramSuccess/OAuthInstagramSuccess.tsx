...
const MESSAGE_TYPE = 'instagram-oauth-success';

/**
 * Page the backend redirects to after Instagram OAuth (INSTAGRAM_SUCCESS_REDIRECT_URI).
 * If opened in a popup (window.opener exists), notifies the opener and closes.
 * Otherwise redirects to home.
 */
export default function OAuthInstagramSuccess() {
  useEffect(() => {
