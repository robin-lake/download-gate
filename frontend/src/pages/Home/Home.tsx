    ...
    <div className="home">
      ...
      <section className="home__free">
        ...
        <p className="home__section-text home__free-text">
          No plans, no trials, no upsells. Download gates and smart links that would cost elsewhere are free here. Built for artists who want to grow without paying a subscription.
        </p>
      </section>
      ...
      <section className="home__opensource">
        ...
        <p className="home__section-text">
          This service is fully open source. You can run it yourself, fork it, and customize it. No lock-in, no black box.
        </p>
      ...
      <section className="home__final-cta">
        <h2 className="home__section-title">Ready to grow your list?</h2>
        <Link to="/signup">
